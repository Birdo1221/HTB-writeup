...
REMOTE_HOST = '94.237.57.183'  # Replace with the IP address or hostname of the remote server
REMOTE_PORT = 31938  # Replace with the port number of the remote server
